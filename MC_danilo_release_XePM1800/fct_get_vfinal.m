function [vxf vyf vzf] = fct_get_vfinal(A,texit_ind_sample,v0x_sample,v0y_sample,v0z_sample,Up,PlotOpt)
...
if PlotOpt==1
    figure;
    vfgrid = -1.*max(sqrt(vxf.^2+vyf.^2+vzf.^2)):1e-2:max(sqrt(vxf.^2+vyf.^2+vzf.^2));
