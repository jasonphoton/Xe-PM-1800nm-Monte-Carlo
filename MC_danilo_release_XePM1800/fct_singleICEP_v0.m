function [vxf_all vyf_all vzf_all vxf_dir vyf_dir vzf_dir vxf_resc vyf_resc vzf_resc T] = fct_singleICEP_v0(int_index, IWcm,CEP,pulse_,atom,nsample,savename,dt,s,...
