...
kmax     = 1;              % number of cep/int settings for vol avg
nsample  = 1e6;             % number of particles per cep/int setting
...
Up       = (0.09337.*5.5e11.*(wvlm.^2))./27.211;   % au
...
else if wvlm == 7000e-9
Up       = (0.09337.*5.5e11.*(wvlm.^2))./27.211;   % au
y_lim = sqrt(2*10*Up)-sqrt(2*3.17*Up);
vpagrid_01 = -1.7:resol:1.7;
vpegrid_01 = -1:resol:1;
    end
end
