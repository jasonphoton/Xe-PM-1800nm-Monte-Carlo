function   fct_Xe1800nm_PM_withdir_savetables_Guass( n, N, CEP, nr_ceps, kmax, nsample, I0, int_spacing, savename2,...
...
%     ysample = Vpegrid(ind)+rand(1,nsample).*(vpegrid(2)-vpegrid(1))/2;
    ...
    [vxf_all vyf_all vzf_all vxf_dir vyf_dir vzf_dir vxf_resc vyf_resc vzf_resc T] = ...
               fct_singleICEP_Gauss(k, Isample(k),CEPsample,pulse,atom,nsample,savename1,dt,s,...
                                 cross_section_fname, cutoff_winkel, save_tables, table_name,...
                                 type, start_at_0, wvlnm, cutoff, z, kdoubleprime, fwhm_nochirp, n_c);                                                                      
...
foldername = [num2str(atom),                '_',...
              num2str(wvlnm),               'nm_',...
              num2str(I0,'%10.1e\n'),       'Wcm2_',...
              num2str(kmax),                'kmax_',...
              num2str(nr_ceps),             'ceps_',...
              num2str(nsample,'%10.0e\n'),  'nsample_',...
              num2str(fwhm_nochirp),        'fs_',...
              num2str(z),                   'mm'];
